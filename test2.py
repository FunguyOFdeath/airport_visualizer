...
while running:
    ...
    screen.blit(font.render("Въезд на место самолёта - движение только в сторону, т.е движение ←", True, BLACK), (50, HEIGHT - 720))
    ...
    screen.blit(font_symbol.render("✈", True, BLACK), (300, HEIGHT - 780))
